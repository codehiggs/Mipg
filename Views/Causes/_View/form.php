...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-05 14:58:26
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Plans\Views\Causes\Editor\form.php]
...
$f = service("forms", array("lang" => "Mipg_Causes."));
//[Request]-----------------------------------------------------------------------------
$row = $model->find($oid);
$r["cause"] = $row["cause"];
$r["plan"] = $row["plan"];
...
$back = "/plans/causes/list/" . lpk();
//[Fields]-----------------------------------------------------------------------------
$f->fields["cause"] = $f->get_FieldView("cause", array("value" => $r["cause"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/plans/causes/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["cause"] . $f->fields["plan"] . $f->fields["score"])));
