...
/* Vars */
$l["back"] = "/mipg/categories/list/{$row['component']}";
$l["edit"] = "/mipg/categories/edit/{$pkey}";
$vsuccess = "mipg/categories-delete-success-message.mp3";
$vnoexist = "mipg/categories-delete-noexist-message.mp3";
/* Build */
