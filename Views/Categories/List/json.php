...
//[Query]---------------------------------------------------------------------------------------------------------------
$list = $model->get_List($limit, $offset, $search, $oid);
$recordsTotal = $model->get_Total($search, $oid);
//$sql=$model->getLastQuery()->getQuery();
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/mipg/categories';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "/mipg/activities/home/{$item["category"]}";
    $editor = "{$component}/edit/{$item["category"]}";
    $deleter = "{$component}/delete/{$item["category"]}";
