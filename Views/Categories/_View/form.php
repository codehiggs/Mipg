...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/mipg/categories/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["category"] . $f->fields["component"] . $f->fields["order"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["name"] . $f->fields["description"] . $f->fields["author"])));
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Categories.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
