...
$mscores = model("App\Modules\Mipg\Models\Mipg_Causes_Scores");
...
$code .= "</tbody>";
$code .= "</table>";
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/mipg/plans/causes/{$oid}", "text" => lang("App.Cancel"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
$info = $bootstrap->get_Card("card-view-service", array(
    "alert" => array(
        'type' => 'secondary',
        'title' => lang("Causes.info-evaluate-title"),
        'message' => lang("Causes.info-evaluate-message"),
        'class' => 'mb-0'),
));
echo($info);
?>