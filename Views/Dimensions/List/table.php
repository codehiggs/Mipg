...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/mipg/api/dimensions/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/mipg/dimensions/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'dimension' => array('text' => lang('App.Dimension'), 'class' => 'text-center', 'visible' => false),
        'reference' => array('text' => lang('App.Deference'), 'class' => 'text-center', 'visible' => false),
        ...
        'description' => array('text' => lang('App.Description'), 'class' => 'text-start', 'visible' => false),
