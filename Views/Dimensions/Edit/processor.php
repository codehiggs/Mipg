...
$asuccess = "mipg/dimensions-edit-success-message.mp3";
$anoexist = "mipg/dimensions-edit-noexist-message.mp3";
//[build]---------------------------------------------------------------------------------------------------------------
if (is_array($row)) {
    $edit = $model->update($d['dimension'], $d);
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Dimensions.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Dimensions.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Dimensions.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Dimensions.edit-noexist-message"), $d['dimension']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
