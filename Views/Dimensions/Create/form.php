...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["dimension"] = $f->get_Value("dimension", pk());
$r["reference"] = $f->get_Value("reference");
$r["process"] = $f->get_Value("process");
...
$processes = array();// $mprocesses->get_SelectData();
...
$f->fields["process"] = $f->get_FieldSelect("process", array("value" => $r["process"], "data" => $processes, "proportion" => "col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["dimension"] . $f->fields["reference"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["process"])));
$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["order"] . $f->fields["name"])));
...
$card = $b->get_Card("create", array(
    "title" => lang("Dimensions.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
