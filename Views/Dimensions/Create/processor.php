...
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Dimensions.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Dimensions.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Dimensions.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Dimensions.create-success-message"), $d['dimension']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
