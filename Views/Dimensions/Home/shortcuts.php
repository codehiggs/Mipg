...
foreach ($dimensions as $dimension) {
    ...
    $code .= "<a href=\"/mipg/politics/home/{$dimension['dimension']}\" class=\"stretched-link\">\n";
...
$info = $bootstrap->get_Card("card-view-service", array(
    "alert" => array(
        'type' => 'secondary',
        'title' => lang("Dimensions.info-title"),
        'message' => lang("Dimensions.info-message"),
        'class' => 'mb-0'),
));
echo($info);
?>