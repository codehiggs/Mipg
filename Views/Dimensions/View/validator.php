...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Dimensions.view-errors-title"));
    $smarty->assign("message", lang("Dimensions.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "mipg/dimensions-view-errors-message.mp3");
