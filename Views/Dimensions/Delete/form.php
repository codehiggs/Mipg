...
$r = $model->where('dimension', $oid)->first();
$name = urldecode($r["name"]);
$message = sprintf(lang("Dimensions.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Dimensions.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Dimensions.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
