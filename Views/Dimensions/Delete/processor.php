...
if (isset($row["dimension"])) {
    ...
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Dimensions.delete-success-title"),
        "text-class" => "text-center",
        "text" => lang("Dimensions.delete-success-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Dimensions.delete-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Dimensions.delete-noexist-message"), $d['dimension']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $vnoexist,
    ));
