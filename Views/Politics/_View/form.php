...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/mipg/politics/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Politics.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
