...
$f->set_ValidationRule("dimension", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Politics.view-errors-title"));
    $smarty->assign("message", lang("Politics.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "mipg/politics-view-errors-message.mp3");
