...
//[vars]----------------------------------------------------------------------------------------------------------------
$back = "/mipg/politics/home/{$oid}";
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/mipg/api/politics/json/list/' . $oid,
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/mipg/politics/create/' . $oid, 'class' => 'btn-secondary'),
    ),
    'cols' => array(
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Politics.list-title'),
    "header-back" => $back,
    "content" => $table,
));
echo($card);
