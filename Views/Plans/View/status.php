...
if ($status == "PENDING" || empty($status)) {
    ...
    $actions = $mactions->get_ListByPlan(10000, 0, $oid);
    ...
    if ($authentication->has_Permission("PLANS-PLANS-APPROVE")) {
        $href = "/mipg/plans/evaluation/{$oid}";
