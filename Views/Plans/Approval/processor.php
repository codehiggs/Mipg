...
$d = array(
    ...
    "status" => "APPROVAL",
    "status_approval" => $f->get_Value("status_approval"),
    "status_approval_date" => $dates->get_Date(),
    "status_approval_time" => $dates->get_Time(),
);
//[Elements]-----------------------------------------------------------------------------
...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "text" => lang("Plans.approval-success-message"),
