...
$f->fields["status"] = $f->get_FieldText("status", array("value" => $r["status"], "proportion" => "col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12", "readonly" => true));
$f->fields["status_approval"] = $f->get_FieldTextArea("status_approval", array("value" => $r["status_approval"], "proportion" => "col-12"));
...
$card = $bootstrap->get_Card("create", array(
    "title" => "Solicitud de Aprobación del plan",
    "content" => $f,
    "header-back" => $back,
    "alert" => array(
        "type" => "info",
