...
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Plans.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Plans.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Plans.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Plans.create-success-message"), $d['plan']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
