...
//[services]------------------------------------------------------------------------------------------------------------
$b = service("bootstrap");
$f = service("forms", array("lang" => "MiPGPlans."));
//[models]--------------------------------------------------------------------------------------------------------------
...
//$f->groups["g1a"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["activity"])));
//$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["manager"] . $f->fields["manager_subprocess"] . $f->fields["manager_position"])));
//$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["order"] . $f->fields["description"] . $f->fields["formulation"])));
//$f->groups["g4"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["value"] . $f->fields["start"] . $f->fields["end"])));
//$f->groups["g5"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["evaluation"])));
//[buttons]-------------------------------------------------------------------------------------------------------------
...
$card = $b->get_Card("create", array(
    "alert" => array(
        ...
        "message" => lang("Plans.info-create-message")
    ),
    "title" => lang("Plans.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
