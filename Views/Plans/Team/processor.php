...
if (isset($row["plan"])) {
    ...
    $c = $bootstrap->get_Card('success', array(
        ...
        'title' => lang("MiPGPlans.edit-success-title"),
        'text' => lang("MiPGPlans.edit-success-message"),
        'footer-class' => 'text-center',
        'footer-continue' => "/mipg/plans/view/{$oid}",
    ...
    $c = $bootstrap->get_Card('warning', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("MiPGPlans.edit-noexist-title"),
        'text' => lang("MiPGPlans.edit-noexist-message"),
        'footer-class' => 'text-center',
        'footer-continue' => "/mipg/plans/view/{$oid}",
