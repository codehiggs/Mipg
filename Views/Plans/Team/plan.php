...
$mprocess = model('App\Modules\Mipg\Models\Mipg_Processes');
$msubprocess = model('App\Modules\Mipg\Models\Mipg_Subprocesses');
$users = model('App\Modules\Mipg\Models\Mipg_Users');
...
<script>
    ...
    function changeSubprocess() {
        ...
        xhr.open("GET", "/mipg/api/positions/json/list/" + subprocess, true);
        xhr.onload = function () {
            if (xhr.status === 200) {
