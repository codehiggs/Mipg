...
$links['categories'] = $bootstrap->get_A("link-$oid", array('href' => "/mipg/activities/home/{$category['category']}", 'content' => $name_category));
$links['activity'] = $bootstrap->get_A("link-$oid", array('href' => "/mipg/plans/home/$oid", 'content' => $name_activity));
