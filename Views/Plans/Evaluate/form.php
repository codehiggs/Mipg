...
$f->fields["status_evaluate"] = $f->get_FieldTextArea("status_evaluate", array("value" => $r["status_evaluate"], "proportion" => "col-12"));
...
$card = $bootstrap->get_Card("create", array(
    "title" => "Solicitud de evaluación del plan",
    "content" => $f,
    "header-back" => $back,
    "alert" => array(
        "type" => "info",
        "title" => lang("Plans.status-evaluate-title"),
        "message" => lang("Plans.status-evaluate-message"),
    ),
));
echo($card);
?>