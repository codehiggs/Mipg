...
$f->set_ValidationRule("criteria", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Activities.view-errors-title"));
    $smarty->assign("message", lang("Activities.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "mipg/activities-view-errors-message.mp3");
