...
$l["back"] = "/mipg/activities/list/{$oid}";
$l["edit"] = "/mipg/activities/edit/{$d["activity"]}";
$asuccess = "mipg/activities-create-success-message.mp3";
$aexist = "mipg/activities-create-exist-message.mp3";
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Activities.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Activities.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Activities.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Activities.create-success-message"), $d['activity']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
