...
$r = $model->where('activity', $oid)->first();
$name = urldecode($r["activity"]);
$message = sprintf(lang("Activities.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Activities.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Activities.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
