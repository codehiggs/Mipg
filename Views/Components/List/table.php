...
//[vars]----------------------------------------------------------------------------------------------------------------
$back = "/mipg/components/home/{$oid}";
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => "/mipg/api/components/json/list/{$oid}",
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => "/mipg/components/create/{$oid}", 'class' => 'btn-secondary'),
    ),
    'cols' => array(
