...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Components.view-errors-title"));
    $smarty->assign("message", lang("Components.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "mipg/components-view-errors-message.mp3");
