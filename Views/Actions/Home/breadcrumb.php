 ...
 *  ** █ ---------------------------------------------------------------------------------------------------------------------
 *  ** █ @authentication, @request, @dates, @parent, @component, @view, @oid, @views, @prefix, @strings, @bootstrap, @session
 *  ** █ ---------------------------------------------------------------------------------------------------------------------
 *  **
 */
/** @var string $oid * */
...
$menu = array(
    ...
    array("href" => "/mipg/activities/home/{$category['category']}", "text" => "Categoría", "class" => false),
    array("href" => "/mipg/plans/view/{$plan['plan']}", "text" => "Plan", "class" => false),
    array("href" => "/mipg/actions/home/{$plan['plan']}", "text" => "Acciones", "class" => true),
);
