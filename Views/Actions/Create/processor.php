...
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Actions.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Actions.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Actions.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Actions.create-success-message"), $d['action']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
