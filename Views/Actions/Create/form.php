...
$msubprocesses = model('App\Modules\Mipg\Models\Mipg_Subprocesses');
$mpositions = model('App\Modules\Mipg\Models\Mipg_Positions');
$miplans = model('App\Modules\Mipg\Models\Mipg_Institutional_Plans');
...
$back = "/mipg/actions/home/{$oid}";
$plan = $mplans->get_Plan($oid);
...
$card = $b->get_Card("create", array(
    "title" => lang("Actions.create-title"),
    "alert" => array(
        'type' => 'info',
        'title' => lang("Actions.create-info-title"),
        'message' => sprintf(lang("Actions.create-info-message"), $plan['start'], $plan['end']),
    ),
    "content" => $f,
    "header-back" => $back
));
...
$info = $b->get_Card("card-view-service", array(
    "alert" => array('type' => 'secondary', 'title' => lang("Actions.create-definition-info-title"), 'message' => lang("Actions.create-definition-info-message"), 'class' => 'mb-0'),
));
echo($info);
?>
