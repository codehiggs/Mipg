...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-05 17:16:40
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Plans\Views\Whys\Delete\form.php]
...
$r = $model->where('why', $oid)->first();
$name = urldecode($r["description"]);
$message = sprintf(lang("Whys.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Whys.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Whys.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
