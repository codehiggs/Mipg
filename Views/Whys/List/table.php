...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-04-16 05:28:50
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Plans\Views\Whys\List\table.php]
...
$back = "/mipg/plans/causes/{$cause['plan']}/";
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => "/mipg/api/whys/json/list/{$oid}/",
    'buttons' => array(
        'create' => array(
            'icon' => ICON_ADD,
            'text' => lang('App.Create'),
            'href' => '/mipg/whys/create/' . $oid,
            'class' => 'btn-secondary'
        ),
    ),
    'cols' => array(
        'why' => array('text' => lang('App.Why'), 'class' => 'text-center', 'visible' => false),
        'cause' => array('text' => lang('App.Cause'), 'class' => 'text-center', 'visible' => false),
