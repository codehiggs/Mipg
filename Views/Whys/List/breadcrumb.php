 ...
 * █ A LAS GARANTÍAS DE COMERCIABILIDAD, APTITUD PARA UN PROPÓSITO PARTICULAR Y NO INFRACCIÓN. EN NINGÚN CASO SERÁ
 * █ LOS AUTORES O TITULARES DE LOS DERECHOS DE AUTOR SERÁN RESPONSABLES DE CUALQUIER RECLAMO, DAÑOS U OTROS
 * █ RESPONSABILIDAD, YA SEA EN UNA ACCIÓN DE CONTRATO, AGRAVIO O DE OTRO MODO, QUE SURJA DESDE, FUERA O EN RELACIÓN
 * █ CON EL SOFTWARE O EL USO U OTROS NEGOCIACIONES EN EL SOFTWARE.
 * █ -------------------------------------------------------------------------------------------------------------------
...
$causes = model('App\Modules\Mipg\Models\Mipg_Causes');
// $oid Recibe  "Plan"
$cause = $causes->get_Cause($oid);
...
$menu = array(
    ...
    array("href" => "/mipg/categories/home/{$component['component']}", "text" => "Componente", "class" => false),
    array("href" => "/mipg/activities/home/{$category['category']}", "text" => "Categoría", "class" => true),
    array("href" => "/mipg/plans/home/{$activity['activity']}", "text" => "Actividad", "class" => true),
    array("href" => "/mipg/plans/causes/{$plan['plan']}", "text" => "Plan", "class" => true),
    array("href" => "/mipg/whys/list/{$cause['cause']}", "text" => "Causa", "class" => true)
);
