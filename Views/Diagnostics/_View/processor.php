...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Diagnostics.view-success-title"),
        'text' => lang("Diagnostics.view-success-message"),
    ...
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Diagnostics.view-noexist-title"),
        'text' => lang("Diagnostics.view-noexist-message"),
        'footer-class' => 'text-center',
