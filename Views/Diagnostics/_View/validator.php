...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("diagnostic", "trim|required");
$f->set_ValidationRule("politic", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Diagnostics.view-errors-title"));
    $smarty->assign("message", lang("Diagnostics.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "mipg/diagnostics-view-errors-message.mp3");
