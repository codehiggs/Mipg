...
//[data]---------------------------------------------------------------------------------------------------------------
$diagnostics = $mdiagnostics->where("politic", $oid)->orderBy("order", "DESC")->findAll();
...
$info = $bootstrap->get_Card("card-view-service", array(
    "alert" => array('type' => 'secondary', 'title' => lang("Diagnostics.mipg-diagnostic-info-title"), 'message' => lang("Diagnostics.mipg-diagnostic-info-message"), 'class' => 'mb-0'),
));
echo($info);
?>