...
//[Query]---------------------------------------------------------------------------------------------------------------
$list = $mdiagnostics->get_List($limit, $offset, $search, $oid);
$recordsTotal = $mdiagnostics->get_Total($search, $oid);
//$sql=$model->getLastQuery()->getQuery();
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/mipg/diagnostics';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "/mipg/components/home/{$item["diagnostic"]}";
    $editor = "{$component}/edit/{$item["diagnostic"]}";
    $deleter = "{$component}/delete/{$item["diagnostic"]}";
