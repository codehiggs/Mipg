...
$l["back"] = "/mipg/scores/home/{$oid}";
$l["edit"] = "/mipg/scores/edit/{$d["score"]}";
$asuccess = "mipg/scores-create-success-message.mp3";
$aexist = "mipg/scores-create-exist-message.mp3";
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Scores.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Scores.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Scores.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Scores.create-success-message"), $d['score']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
