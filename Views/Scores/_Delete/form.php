...
$r = $model->where('score', $oid)->first();
$name = urldecode($r["name"]);
$message = sprintf(lang("Scores.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Scores.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Scores.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
