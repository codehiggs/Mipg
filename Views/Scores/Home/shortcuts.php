...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => sprintf(lang('Scores.home-title'), ""),
    "header-back" => $back,
...
$info = $bootstrap->get_Card("card-view-service", array(
    "alert" => array('type' => 'secondary', 'title' => lang("Mipg.califications-info-title"), 'message' => lang("Mipg.califications-info-message"), 'class' => 'mb-0'),
));
echo($info);
?>