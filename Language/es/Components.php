...
return [
    ...
    "create-duplicate-message" => "Este componente ya se había registrado previamente, presioné continuar en la parte inferior de este mensaje para retornar al listado general de componentes.",
    "create-success-title" => "¡Componente registrado exitosamente!",
    "create-success-message" => "El componente se registró exitosamente, para retornar al listado general de componentes presioné continuar en la parte inferior de este mensaje.",
    // - Components viewer
    ...
    "edit-noexist-message" => "El elemento que actualizar no existe o se elimino previamente, para retornar al listado general de componentes presioné continuar en la parte inferior de este mensaje. ",
    "edit-success-title" => "¡componente actualizada!",
    "edit-success-message" => "Los datos de componente se <b>actualizaron exitosamente</b>, para retornar al listado general de componentes presioné el botón continuar en la parte inferior del presente mensaje.",
    // - Components deleter
    ...
    "delete-message" => "Para confirmar la eliminación del componente <b>%s</b>, presioné eliminar, para retornar al listado general de componentes presioné cancelar.",
    ...
    "delete-noexist-message" => "\El elemento que intenta eliminar no existe o se elimino previamente, para retornar al listado general de componentes presioné continuar en la parte inferior de este mensaje.",
    "delete-success-title" => "¡componente eliminad@ exitosamente!",
    "delete-success-message" => "La componente se elimino exitosamente, para retornar al listado de general de componentes presioné el botón continuar en la parte inferior de este mensaje.",
    // - Components list
