...
return [
    ...
    "help_name" => "Alfa numérico (Requerido)",
    "help_description" => "Alfa numérico (Requerido)",
    "help_author" => "author",
    ...
    "create-duplicate-message" => "Este categoría ya se había registrado previamente, presioné continuar en la parte inferior de este mensaje para retornar al listado general de categorías.",
    "create-success-title" => "¡Categoría registrada exitosamente!",
    "create-success-message" => "La categoría se registró exitosamente, para retornar al listado general de categorías presioné continuar en la parte inferior de este mensaje.",
    // - Categories viewer
    ...
    "edit-noexist-message" => "El elemento que actualizar no existe o se elimino previamente, para retornar al listado general de categorías presioné continuar en la parte inferior de este mensaje. ",
    "edit-success-title" => "¡categoría actualizada!",
    "edit-success-message" => "Los datos de categoría se <b>actualizaron exitosamente</b>, para retornar al listado general de categorías presioné el botón continuar en la parte inferior del presente mensaje.",
    // - Categories deleter
    ...
    "delete-message" => "Para confirmar la eliminación del categoría <b>%s</b>, presioné eliminar, para retornar al listado general de categorías presioné cancelar.",
    ...
    "delete-noexist-message" => "\El elemento que intenta eliminar no existe o se elimino previamente, para retornar al listado general de categorías presioné continuar en la parte inferior de este mensaje.",
    "delete-success-title" => "¡categoría eliminad@ exitosamente!",
    "delete-success-message" => "La categoría se elimino exitosamente, para retornar al listado de general de categorías presioné el botón continuar en la parte inferior de este mensaje.",
    // - Categories list
