...
return [
    ...
    "delete-message" => "Para confirmar la eliminación del Causa <b>%s</b>, presione eliminar. Para retornar al listado general de causas, presione cancelar.",
