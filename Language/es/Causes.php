...
return [
    ...
    "create-title" => "Crear nuevo Causa",
    ...
    "create-success-message" => "La Causa se registró exitosamente, para retornar al listado general de causas presioné continuar en la parte inferior de este mensaje.",
    // - Causes viewer
    ...
    "edit-noexist-message" => "El elemento que actualizar no existe o se elimino previamente, para retornar al listado general de causas presioné continuar en la parte inferior de este mensaje. ",
    "edit-success-title" => "¡Causa actualizada!",
    "edit-success-message" => "Los datos de Causa se <b>actualizaron exitosamente</b>, para retornar al listado general de causas presioné el botón continuar en la parte inferior del presente mensaje.",
    // - Causes deleter
    ...
    "delete-message" => "Para confirmar la eliminación del Causa <b>%s</b>, presioné eliminar, para retornar al listado general de causas presioné cancelar.",
    ...
    "delete-noexist-message" => "\El elemento que intenta eliminar no existe o se elimino previamente, para retornar al listado general de causas presioné continuar en la parte inferior de este mensaje.",
    "delete-success-title" => "¡Causa eliminad@ exitosamente!",
    "delete-success-message" => "La Causa se elimino exitosamente, para retornar al listado de general de causas presioné el botón continuar en la parte inferior de este mensaje.",
    // - Causes list
    ...
    "evaluation-success-message" => "La evaluación de las causas se realizó exitosamente, para ver los resultados presioné continuar en la parte inferior de este mensaje.",
