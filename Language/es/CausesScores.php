...
return [
    ...
    "create-success-message" => "La #singular se registró exitosamente. Para retornar al listado general de #plural, presione continuar en la parte inferior de este mensaje.",
    // - Causes viewer
    ...
    "edit-noexist-message" => "El elemento que actualizar no existe o se elimino previamente. Para retornar al listado general de #plural, presione continuar en la parte inferior de este mensaje. ",
    "edit-success-title" => "¡#singular actualizada!",
    "edit-success-message" => "Los datos de #singular se <b>actualizaron exitosamente</b>. Para retornar al listado general de #plural, presione el botón continuar en la parte inferior del presente mensaje.",
    // - Causes deleter
    ...
    "delete-message" => "Para confirmar la eliminación del #singular <b>%s</b>, presione eliminar. Para retornar al listado general de #plural, presione cancelar.",
    ...
    "delete-noexist-message" => "El elemento que intenta eliminar no existe o se elimino previamente. Para retornar al listado general de #plural, presione continuar en la parte inferior de este mensaje.",
    "delete-success-title" => "¡#Singular eliminad@ exitosamente!",
    "delete-success-message" => "La #singular se elimino exitosamente. Para retornar al listado de general de #plural, presione el botón continuar en la parte inferior de este mensaje.",
    // - Causes list
