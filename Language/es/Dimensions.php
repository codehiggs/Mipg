...
return [
    ...
    "dimensions-info" => "En el contexto del MIPG (Modelo Integrado de Planeación y Gestión), una dimensión se refiere a un aspecto o área temática específica que se considera importante en la planeación y gestión pública. Estas dimensiones representan áreas clave que deben ser abordadas para lograr los objetivos estratégicos y mejorar la gestión gubernamental. ",
    "info-title" => "Recuerde",
